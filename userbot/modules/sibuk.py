...
async def set_afk(afk_e):
    ...
    if string:
        AFKREASON = string
        await afk_e.edit(f"**✵ ALPHABOT ✵**\n╭✠╼━━━━━━❖━━━━━━━✠╮\n┣❑ {ALIVE_NAME} __Lagi Sibuk__\n┣❑ ᴀʟᴀꜱᴀɴ : `{string}`\n╰✠╼━━━━━━❖━━━━━━━✠╯")
    else:
        await afk_e.edit(f"**SEDANG SIBUK**\n╭✠╼━━━━━━❖━━━━━━━✠╮ \n┣❑ {ALIVE_NAME} __Lagi Sibuk__ \n╰✠╼━━━━━━❖━━━━━━━✠╯")
    if user.last_name:
...
async def type_afk_is_not_true(notafk):
    ...
    if ISAFK:
        ISAFK = False
        msg = await notafk.respond(f"`{ALIVE_NAME} Sudah tidak sibuk lagi...`")
        time.sleep(7)
        await msg.delete()
