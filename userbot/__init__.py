...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/zeeoneofc/Alpha-userbot.git")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://l.top4top.io/p_19851eqgt1.jpg"
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "```Alpha-userbot Telah Aktif``` jangan lupa join group support @alphabot_support")
    return
    ...
    try:
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url(
                                "Alpha-userbot",
                                "https://github.com/zeeoneofc/Alpha-userbot"),
                            custom.Button.url(
                                "Pemilik",
                                "t.me/zeeoneee")],
                    ],
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # pylint:disable=E0602
                ...
                reply_pop_up_alert = f"PERINGATAN❗️ Buatlah  Userbot Anda Sendiri, Jangan Menggunakan Milik  {ALIVE_NAME}"
