...
async def _(event):
    try:
        ...
        await event.edit("`Mohon Menunggu Alpha Sedang Mencari Wallpaper.....`")
        async with bot.conversation("@SaitamaRobot") as conv:
            ...
            if r1.text.startswith("No"):
                return await event.edit(f"`Alpha Tidak Menemukan Wallpaper Yang Anda Cari`")
            else:
        ...
        return await event.edit("`Alpha Tidak Menemukan Wallpaper Yang Anda Cari`")
