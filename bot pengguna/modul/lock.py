...
async def locks(event):
    ...
    if input_str == "msg":
        ...
        if not input_str:
            await event.edit("`Mohon Maaf, Apa Yang Harus Alpha Kunci?..⚡`")
            return
        else:
    ...
    try:
        ...
        await event.edit(f"`Alpha Telah Mengunci {what} Untuk Obrolan Ini`")
    except BaseException as e:
        await event.edit(
            f"`Apakah Alpha Mempunyai Izin Melakukan Itu Disini?`\n**Kesalahan:** {str(e)}")
        return
...
async def rem_locks(event):
    ...
    if input_str == "msg":
        ...
        if not input_str:
            await event.edit("`Apa Yang Harus Alpha Buka?..⚡`")
            return
        else:
    ...
    try:
        ...
        await event.edit(f"`Alpha Telah Membuka Kunci {what} Untuk Obrolan Ini`")
    except BaseException as e:
        await event.edit(
            f"`Apakah Alpha Mempunyai Izin Melakukan Itu Disini?`\n**Kesalahan:** {str(e)}")
        return
